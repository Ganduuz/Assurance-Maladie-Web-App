...
class Nouveaubulletin extends StatefulWidget {
   final List<Bulletins_Soins> bulletinsSoins;
   Size get preferredSize => const Size.fromHeight(50);
  Nouveaubulletin({required this.bulletinsSoins});
  @override
  _NouveauBulletinState createState() => _NouveauBulletinState();
}

class _NouveauBulletinState extends State<Nouveaubulletin> {
